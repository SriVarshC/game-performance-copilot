...
def test_predict_fps_is_positive():
...
def test_predict_frame_time_is_positive():
...
def test_predict_valid_performance_tier():
...
def test_predict_model_name_returned():
...
def test_predict_ray_tracing_on():
